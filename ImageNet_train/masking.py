...
if __name__ == '__main__':
    ...
    folder_list=os.listdir('###Imagenet dataset 위치###/train/')
    os.mkdir('###Imagenet dataset 배경제거 이미지 위치###/train/')
    os.mkdir('###Imagenet dataset making 위치###/train_pred/')
    #os.mkdir('/home/dircon/seoyun/test_result/train/new/')
    for i in folder_list:
        folder=i+'/'
        print(folder)
        #os.mkdir('/root/default/BASNet/test_result/val/'+folder)
        os.mkdir('###Imagenet dataset 배경제거 이미지 위치###/train/'+folder)
        os.mkdir('###Imagenet dataset making 위치###/train_pred/'+folder)
        image_dir = '###Imagenet dataset 위치###/train/'+folder
        prediction_dir = '###Imagenet dataset making 위치###/train_pred/'+folder
        model_dir = '###basnet.pth 위치###'
        img_name_list = glob.glob(image_dir + '*.JPEG')
        ...
        for i_test, data_test in enumerate(test_salobj_dataloader):
            ...
            dir='###Imagenet dataset 배경제거 이미지 위치###/train/'+folder+name+'.JPEG'
